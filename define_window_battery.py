...
def openNewWindow():
    ...
    # HVAC label
    num_br = Label(frame1, text="Insert the number of HVAC for each EH") 
    num_br.grid(row=9,column=2,padx=200)
    ...
    # HVAC entry
    Ginv_entry = Entry(frame1, textvariable=number_of_HVAC)
    Ginv_entry.grid(row=11,column=2,padx=200,sticky=W)
